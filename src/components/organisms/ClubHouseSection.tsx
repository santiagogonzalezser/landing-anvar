...
export const ClubHouseSection: React.FC = () => {
  const [selectedCategory, setSelectedCategory] = useState(0);

  const currentCategory = CLUB_HOUSE_CATEGORIES[selectedCategory];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-2 sm:mb-3">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg px-4 max-w-3xl mx-auto" style={{ color: theme.colors.accent, opacity: 0.8 }}>
            Más de 1,250m² de amenidades premium y espacios comerciales
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-4 lg:gap-5 items-center">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {CLUB_HOUSE_CATEGORIES.map((category, index) => (
                <button
                  key={category.id}
