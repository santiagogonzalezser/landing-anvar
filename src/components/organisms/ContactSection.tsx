  ...
  return (
    <>
      <section id="contacto" className="relative z-10 py-3 sm:py-5 md:py-7 lg:py-8 px-3 sm:px-5 md:px-7 lg:px-8" style={{ backgroundColor: '#8e8066' }}>
        <div className="max-w-4xl mx-auto text-center scale-[0.65] sm:scale-[0.7] md:scale-[0.75] lg:scale-[0.8]">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-6 sm:mb-8 px-2" style={{ color: '#27312d' }}>
            Accede al Lanzamiento
          </h2>
          <p className="text-xs sm:text-sm md:text-base lg:text-lg mb-6 sm:mb-8 max-w-3xl mx-auto px-4" style={{ color: '#27312d', opacity: 0.8 }}>
